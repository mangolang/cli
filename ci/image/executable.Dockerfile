...
RUN find . -wholename '*/release/*' -name 'mangod' -type f -executable -print -exec cp {} /mango/mangod_exe \;

RUN ls -als /mango/mango_exe /mango/mangod_exe
...
COPY --from=build /mango/mangod_exe /mangod
